...
## Boilerplate
Create our usual boilerplate code in [code01.py]{.filename}:
...
::: {.program}
Put your boilerplate code into [code01.py]{.program-filename}.
:::
...
::: {.program}
Put updated code in [code02.py]{.program-filename}  and create the class [Target]{.progam-class} in a separate file.
:::
...
::: {.program}
Put updated code in [code03.py]{.program-filename} and update the class [Target]{.progam-class}.
:::
...
I would suggest creating and testing both function in a Jupyter notebook first and then putting them in a separate file (e.g., [generators.py]{.filename}). Be careful if you decide to use a for loop instead of `next()` for testing. Remember, both a generators and will never run out of items to yield for a for loop!

::: {.program}
Put both generators into [generators.py]{.program-filename}.
:::
...
::: {.program}
Put updated code in [code04.py]{.program-filename}  and create the class [TimedResponseTask]{.program-class}.
:::
...
::: {.program}
Update classes [Target]{.program-class} and [TimedResponseTask]{.program-class}.
:::
...
::: {.program}
Update class [TimedResponseTask]{.program-class}.
:::
...
::: {.program}
Put updated code in [code05.py]{.program-filename}, update [Target]{.program-class} and [TimedResponseTask]{.program-class} classes.
:::
...
::: {.program}
Put updated code in [code06.py]{.program-filename}, create [ScoreText]{.program-class} class.
:::
...
::: {.program}
Update [TimedTaskResponse]{.program-class} class.
:::
...
::: {.program}
Put updated code in [code07.py]{.program-filename}.
:::
...
::: {.program}
Put updated code in [code08.py]{.program-filename} using [TimedResponseTask2]{.program-class}.
:::
...
::: {.program}
Save staircase logs in [code09.py]{.program-filename}.
:::
