...
Wenn du Windows nutzt, lade und installiere die [Standalone PsychoPy](https://www.psychopy.org/download.html) Version herunter. Nimm einfach die neueste (und beste) PsychoPy Version, die dir empfohlen wird (Stand PsychoPy 2023.2.2 mit Python 3.8) und folge den Anweisungen.
