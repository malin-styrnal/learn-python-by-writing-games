...
Grab the [exercise notebook](notebooks/06-Whack-a-mole.ipynb) before we start!
...
## Basic game scaffolding {#psychopy-scaffolding}
...
::: {.program}
Put your modified code into [code04.py]{.program-filename}.
:::
...
::: {.program}
Put your modified code into [code05.py]{.program-filename}.
:::
...
However, Python has a nifty trick called [Unpacking Argument Lists](https://docs.python.org/3/tutorial/controlflow.html#tut-unpacking-arguments): You can pass a list of arguments prepended by an asterisk and Python will unpack the list into arguments in the same order they are in the list: first value goes to the parameter, second value to the second parameter, etc. So, in our case, the code can be simplified to
```python
...
::: {.program}
Put your code into [code06.py]{.program-filename}.
:::
...
::: {.program}
Put your code into [code07.py]{.program-filename}.
:::
