...
Ich hoffe, du hast bereits einen speziellen Ordner für dieses Buch [erstellt](#files-folder). Lade das [Übungsheft](notebooks/Basics.ipynb) herunter (Alt+Klick sollte es herunterladen statt zu öffnen), lege es in einen Kapitelordner und öffne es, siehe [relevante Anweisungen](#jupyter-notebooks). Du wirst zwischen Erklärungen hier und den Übungen im Heft hin- und herspringen müssen, also halte beide offen.
