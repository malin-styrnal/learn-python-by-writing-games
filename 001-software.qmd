...
If you are using Windows, download and install [Standalone PsychoPy](https://www.psychopy.org/download.html) version. Use whatever the latest (and greatest) PsychoPy version is suggested to you (PsychoPy 2024.2.3 using Python 3.10 as of time of writing) and follow instructions. 
